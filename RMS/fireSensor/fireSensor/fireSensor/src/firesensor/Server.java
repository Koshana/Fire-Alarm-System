...
//------Floor JSON
//------------------------------------------------------------------------------
        String floor_response = new httpJson().jsonRequest("https://code.techmogeen.com/api/allfloors");
...
//------Room JSON  
//------------------------------------------------------------------------------
        String room_response = new httpJson().jsonRequest("https://code.techmogeen.com/api/allrooms");
...
//------Room JSON  
//------------------------------------------------------------------------------
        String sensor_response = new httpJson().jsonRequest("https://code.techmogeen.com/api/allsensors");
...
//------FetchAllData JSON  
//------------------------------------------------------------------------------
        String fetchAllData_response = new httpJson().jsonRequest("https://code.techmogeen.com/api/fetchSensors");
